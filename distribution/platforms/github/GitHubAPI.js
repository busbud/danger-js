                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, allComments
                                .filter(function (comment) { return voca_1.default.includes(comment.body, dangerIDMessage); }) // does it contain the right danger ID?
                                .filter(function (comment) { return comment.user.id === userID; }) // Does it have the right user ID?
                                .filter(function (comment) { return voca_1.default.includes(comment.body, githubIssueTemplate_1.dangerSignaturePostfix); }) // Does it look like a danger message?
